...
public class Util {
     ...
     *
     * @param min Minimum value. Must be a real number.
     ...
     * @throws InterruptedException thrown when an inactive thread is interrupted by another thread
    ...
    /**
     * An enumeration representing two programming languages: Java and Python.
     */
    public enum HW {JAVA, PYTHON}
}
